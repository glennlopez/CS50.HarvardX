...
void blur(int height, int width, RGBTRIPLE image[height][width])
{
    ...
    for (int col = 0; col < height; col++) //y
    {
        ...
        for (int row = 0; row < width; row++) //x
        {
            ...
            if (!(isCorner(col, row, height, width) == 1) && !(isEdge(col, row, height, width) == 1)
                && !(isCorner(col, row, height, width) == 2) && !(isEdge(col, row, height, width) == 4)
            ...
            if (!(isCorner(col, row, height, width) == 1) && !(isEdge(col, row, height, width) == 1)
                && !(isCorner(col, row, height, width) == 2) && !(isEdge(col, row, height, width) == 2)
            ...
            if (!(isCorner(col, row, height, width) == 2) && !(isEdge(col, row, height, width) == 2)
                && !(isCorner(col, row, height, width) == 4))
            {
            ...
            if (!(isCorner(col, row, height, width) == 1) && !(isEdge(col, row, height, width) == 4)
                && !(isCorner(col, row, height, width) == 3) && !(isEdge(col, row, height, width) == 3)
                && !(isCorner(col, row, height, width) == 4))
            {
            ...
            if (!(isCorner(col, row, height, width) == 3) && !(isEdge(col, row, height, width) == 3)
                && !(isCorner(col, row, height, width) == 4))
            {
            ...
            {
                avgBlue = round((X.rgbtBlue + E.rgbtBlue + G.rgbtBlue + H.rgbtBlue) / 4.0);
                avgGreen = round((X.rgbtGreen + E.rgbtGreen + G.rgbtGreen + H.rgbtGreen) / 4.0);
                avgRed = round((X.rgbtRed + E.rgbtRed + G.rgbtRed + H.rgbtRed) / 4.0);
            ...
            {
                avgBlue = round((X.rgbtBlue + D.rgbtBlue + F.rgbtBlue + G.rgbtBlue) / 4.0);
                avgGreen = round((X.rgbtGreen + D.rgbtGreen + F.rgbtGreen + G.rgbtGreen) / 4.0);
                avgRed = round((X.rgbtRed + D.rgbtRed + F.rgbtRed + G.rgbtRed) / 4.0);
            ...
            {
                avgBlue = round((X.rgbtBlue + B.rgbtBlue + C.rgbtBlue + E.rgbtBlue) / 4.0);
                avgGreen = round((X.rgbtGreen + B.rgbtGreen + C.rgbtGreen + E.rgbtGreen) / 4.0);
                avgRed = round((X.rgbtRed + B.rgbtRed + C.rgbtRed + E.rgbtRed) / 4.0);
            ...
            {
                avgBlue = round((X.rgbtBlue + A.rgbtBlue + B.rgbtBlue + D.rgbtBlue) / 4.0);
                avgGreen = round((X.rgbtGreen + A.rgbtGreen + B.rgbtGreen + D.rgbtGreen) / 4.0);
                avgRed = round((X.rgbtRed + A.rgbtRed + B.rgbtRed + D.rgbtRed) / 4.0);
            ...
            {
                avgBlue = round((D.rgbtBlue + X.rgbtBlue + E.rgbtBlue + F.rgbtBlue + G.rgbtBlue + H.rgbtBlue) / 6.0);
                avgGreen = round((D.rgbtGreen + X.rgbtGreen + E.rgbtGreen + F.rgbtGreen + G.rgbtGreen + H.rgbtGreen) / 6.0);
                avgRed = round((D.rgbtRed + X.rgbtRed + E.rgbtRed + F.rgbtRed + G.rgbtRed + H.rgbtRed) / 6.0);
            ...
            {
                avgBlue = round((A.rgbtBlue + B.rgbtBlue + D.rgbtBlue + X.rgbtBlue + F.rgbtBlue + G.rgbtBlue) / 6.0);
                avgGreen = round((A.rgbtGreen + B.rgbtGreen + D.rgbtGreen + X.rgbtGreen + F.rgbtGreen + G.rgbtGreen) / 6.0);
                avgRed = round((A.rgbtRed + B.rgbtRed + D.rgbtRed + X.rgbtRed + F.rgbtRed + G.rgbtRed) / 6.0);
            ...
            {
                avgBlue = round((A.rgbtBlue + B.rgbtBlue + C.rgbtBlue + D.rgbtBlue + X.rgbtBlue + E.rgbtBlue) / 6.0);
                avgGreen = round((A.rgbtGreen + B.rgbtGreen + C.rgbtGreen + D.rgbtGreen + X.rgbtGreen + E.rgbtGreen) / 6.0);
                avgRed = round((A.rgbtRed + B.rgbtRed + C.rgbtRed + D.rgbtRed + X.rgbtRed + E.rgbtRed) / 6.0);
            ...
            {
                avgBlue = round((B.rgbtBlue + C.rgbtBlue + X.rgbtBlue + E.rgbtBlue + G.rgbtBlue + H.rgbtBlue) / 6.0);
                avgGreen = round((B.rgbtGreen + C.rgbtGreen + X.rgbtGreen + E.rgbtGreen + G.rgbtGreen + H.rgbtGreen) / 6.0);
                avgRed = round((B.rgbtRed + C.rgbtRed + X.rgbtRed + E.rgbtRed + G.rgbtRed + H.rgbtRed) / 6.0);
            ...
            {
                avgBlue = round((A.rgbtBlue + B.rgbtBlue + C.rgbtBlue + D.rgbtBlue + X.rgbtBlue + E.rgbtBlue + F.rgbtBlue + G.rgbtBlue +
                                 H.rgbtBlue) / 9.0);
                avgRed = round((A.rgbtRed + B.rgbtRed + C.rgbtRed + D.rgbtRed + X.rgbtRed + E.rgbtRed + F.rgbtRed + G.rgbtRed + H.rgbtRed) / 9.0);
                avgGreen = round((A.rgbtGreen + B.rgbtGreen + C.rgbtGreen + D.rgbtGreen + X.rgbtGreen + E.rgbtGreen + F.rgbtGreen + G.rgbtGreen +
                                  H.rgbtGreen) / 9.0);
